            ...
            <div class="row">
                <div class="col-md-6 col-lg-6 mb-4">
                    <div class="service-box">
                        ...
                        <h4 class="service-box-title">Cung ứng lao động phổ thông</h4>
                        <p>
                ...
                <div class="col-md-6 col-lg-6 mb-4">
                    <div class="service-box">
                        ...
                        <h4 class="service-box-title">Cung ứng lao động kỹ thuật</h4>
                        <p>
                ...
                <div class="col-md-6 col-lg-6 mb-4">
                    <div class="service-box">
                        ...
                        <h4 class="service-box-title">Đào tạo ngoại ngữ</h4>
                        <p>
                ...
                <div class="col-md-6 col-lg-6 mb-4">
                    <div class="service-box">
                        ...
                        <h4 class="service-box-title">Đào tạo nghề</h4>
                        <p>
